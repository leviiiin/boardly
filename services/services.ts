...
export const boardDataService = {
  ...
  async createBoardWithDefaultColumns(supabase: SupabaseClient, boardData: {
    ...
    const board = await boardService.createBoard(supabase, {
      ...
      color: boardData.color || "bg-green-600",
      user_id: boardData.userId,
    });

    const defaultColumns = [
      { title: "To Do", sort_order: 0, board_id: board.id, user_id: boardData.userId },
      { title: "In Progress", sort_order: 1, board_id: board.id, user_id: boardData.userId },
      { title: "Review", sort_order: 2, board_id: board.id, user_id: boardData.userId },
      { title: "Done", sort_order: 3, board_id: board.id, user_id: boardData.userId },
    ];
